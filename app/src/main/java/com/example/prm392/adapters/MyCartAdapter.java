...
public class MyCartAdapter extends RecyclerView.Adapter<MyCartAdapter.ViewHolder> {
    ...
    Context context;
    List<MyCartModel> cartModellList;


    public MyCartAdapter(Context context, List<MyCartModel> cartModellList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        MyCartModel model = cartModellList.get(position);
        ...
        // Tính tổng giá trị
        int totalPrice = 0;
        for (MyCartModel cart : cartModellList) {
    ...
    private void removeItemFromDatabase(MyCartModel model, int position) {
