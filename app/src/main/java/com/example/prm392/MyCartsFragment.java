...
import com.example.prm392.adapters.MyCartAdapter;
        ...
        db.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    MyCartModel cartModell = snapshot.getValue(MyCartModel.class);
                    cartModell.setDocumentId(documentId);
                    if (cartModell != null) {
                        cartModelList.add(cartModell);
                    }
                }
